...
const SearchAndHistory = ({
    ...
    <div className="w-full">
            ...
            <div className="grid grid-cols-[1fr_1fr_1.5fr_1.5fr_160px]">
                ...
                <div className="bg-white flex items-center justify-center px-2 border-r border-gray-200 h-16">
                    <input
                        ...
                        onChange={(e) =>
                            setSearchFilters((prev: any) => ({ ...prev, time: e.target.value }))
                        }
                    />
                </div>
        ...
        <div className="text-center mb-12">
            <button
                onClick={() => {
                    setSearchFilters({ date: "", time: "", location: "", specialty: "" });
                    setStep("vet-list");
                }}
            ...
            <div className="bg-[#e5e5e5] rounded-[2rem] p-10 shadow-lg max-w-3xl mx-auto relative overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-gray-300">
                        ...
                        <p className="text-lg font-medium text-gray-800">
                            {PROCEDURE_OPTIONS[selectedAppointment.reason] ??
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className="bg-[#5c5c5c] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#4a4a4a] shadow-md transition-all"
                    >
                        Επιστροφή
                    </button>
                </div>
        ...
        <div className="w-full">
            ...
            <div className="bg-[#e5e5e5] rounded-3xl p-8 shadow-lg max-w-2xl mx-auto">
                <div className="mb-6">
                    ...
                    <div className="bg-white p-3 rounded-xl border border-gray-300 text-gray-500">
                        {selectedAppointment?.vetName}
                    </div>
                </div>
                ...
                <div className="mb-8">
                    ...
                    >
                        ...
                        <optgroup label="Αλλο">
                            ...
                            <option value={"Έκτακτο"}>Έκτακτο</option>
                ...
                <div className="flex justify-end gap-4">
                    <button
                        onClick={() => setStep("search")}
                        className="px-6 py-3 bg-gray-400 text-white font-bold rounded-xl hover:bg-gray-500"
                    >
                        Ακύρωση
                    </button>
                    <button
                        onClick={handleSave}
                        className="px-6 py-3 bg-[#5c5c5c] text-white font-bold rounded-xl hover:bg-[#4a4a4a] shadow-md"
                    >
                        Αποθήκευση
                    </button>
                </div>
        ...
        <div className="w-full">
            ...
            {(searchFilters.location || searchFilters.specialty) && (
                <div className="flex gap-2 mb-6">
                    ...
                    <button
                        onClick={() =>
                            setSearchFilters({ ...searchFilters, location: "", specialty: "" })
                        }
            ...
            <div className="bg-[#e5e5e5] rounded-3xl p-8 shadow-lg max-w-4xl mx-auto">
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className="bg-[#5c5c5c] text-white px-16 py-4 rounded-xl font-bold hover:bg-[#4a4a4a] text-lg shadow-lg hover:shadow-xl transition-all"
                    >
                        Οριστικοποίηση
                    </button>
                </div>
...
const SuccessPage = ({ setStep }: any) => (
    <div className="w-full text-center">
        ...
        <button
            onClick={() => setStep("search")}
            className="bg-[#5c5c5c] text-white px-8 py-3 rounded-xl font-bold hover:bg-[#4a4a4a] shadow-md"
        >
            Επιστροφή
        </button>
    </div>
    ...
    <div className="w-full text-center mt-8">
        <div className="bg-[#e5e5e5] rounded-4xl p-10 shadow-lg max-w-2xl mx-auto relative overflow-hidden border-t-8 border-red-500">
            ...
            <div className="flex justify-center gap-6">
                <button
                    onClick={() => setStep("search")}
                    className="px-8 py-3 bg-[#9ca3af] text-white font-bold rounded-xl hover:bg-[#888f9b]"
                >
                    Όχι, Επιστροφή
                </button>
                <button
